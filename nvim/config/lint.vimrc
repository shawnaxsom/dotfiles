" TODO: Remove this? I am using ALE and Neoformat instead.
"       While it is nice to not use a plugin, ALE and Neoformat keep line
"       position better, have more features, runs faster, adds gutter
"       indicators.
