...
augroup markdown
  autocmd!
  " autocmd BufEnter   *.md cd %:p:h
  " autocmd BufLeave   *.md Rooter
  autocmd BufEnter   *.md nnoremap <buffer> <C-]> vi]y:edit %:h/<C-R>".md<CR>
  autocmd BufEnter   *.md vnoremap <buffer> <C-]> y:edit %:h/<C-R>"<CR>.md
